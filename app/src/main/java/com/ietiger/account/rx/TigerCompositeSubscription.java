...
public class TigerCompositeSubscription implements Subscription {
     ...
     */
    public TigerCompositeSubscription() {
        // start empty
    }

    public TigerCompositeSubscription(final Subscription... subscriptions) {
